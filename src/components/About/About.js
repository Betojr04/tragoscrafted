      ...
      <div className="row align-items-center">
        ...
        <div className="col-md-6">
          ...
          <p>
            ...
            fast-paced, high-volume restaurant bar, we specialize in delivering
            quality craft cocktails efficiently, without sacrificing creativity
            ...
            <br></br>
            <br></br>
            Let us handle the bar so you can focus on your event.
          </p>
        </div>
      </div>
    </section>
